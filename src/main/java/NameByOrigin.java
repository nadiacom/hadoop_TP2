...
public class NameByOrigin {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(NameByOrigin.TokenizerMapper.class);
        job.setCombinerClass(NameByOrigin.IntSumReducer.class);
        job.setReducerClass(NameByOrigin.IntSumReducer.class);
